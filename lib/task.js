...
var CouplingStream = function(next, kwargs) {
  kwargs = kwargs || {};
  Writable.call(this, {objectMode: (kwargs.objectMode === true)});
  var payloadTrail = LogTracer.ROOT.branch({ key: 'payloadId', value: kwargs.payloadId });
  ...
  this.close = function(opts) {
    ...
    this.emit('error', { message: 'Stream piping is interrupted' });
  }
