              ...
              if (hasRecycler.call(self)) {
                ...
                if (err) {
                  ...
                  if (headers[rcfg.redeliveredCountName] <= rcfg.redeliveredLimit) {
                    ...
                    enqueueConsumer.call(self, msg.content, {headers: headers});
                  } else {
                    debugx.enabled && debugx('consume() - enqueueRecycler message');
                    enqueueRecycler.call(self, msg.content, {headers: headers});
                  }
                }
                ch.ack(msg);
              } else {
              ...
              if (hasRecycler.call(self)) {
                ...
                if (err) {
                  ...
                  if (headers[rcfg.redeliveredCountName] <= rcfg.redeliveredLimit) {
                    ...
                    enqueueFeedback.call(self, msg.content, {headers: headers});
                  } else {
