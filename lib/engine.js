...
var Engine = function(params) {
  ...
  this.ready = function() {
    ...
    if (config.exchangeName) {
      readyPromise = self.acquireChannel(function(ch) {
        return assertExchange({ channel: ch });
      });
    } else {
  ...
  this.consume = function(callback, options) {
    ...
    return branchConsumerSandbox(options).then(function(sandbox) {
  ...
  var lockProducer = function() {
    ...
    if (!producerSandbox.channel && producerSandbox.mutex) {
      ...
      if (producerSandbox.fence) {
        producerPromise = new Promise(function(onResolved, onRejected) {
        ...
        producerPromise = Promise.resolve(producerSandbox);
      }
    }
  ...
  var branchConsumerSandbox = function(opts) {
