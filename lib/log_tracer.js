...
Object.defineProperty(LogTracer, 'libraryInfo', {
  get: function() {
...
var LX = LogAdapter.getLogger({ scope: 'opflow:LogTracer' });
LX.log('info', new LogTracer().add(LogTracer.libraryInfo).toString());
