...
var RpcWorker = function(params) {
  ...
  LW.isEnabledFor('info') && LW.log('info', rpcWorkerTrail.add().toMessage({
    text: 'RpcWorker.new()'
  }));
  ...
  this.ready = function() {
    ...
    LW.isEnabledFor('info') && LW.log('info', readyTrail.add().toMessage({
  ...
  this.process = function(checker, callback) {
    ...
    if (typeof(checker) === 'string') {
      ...
      LW.isEnabledFor('debug') && LW.log('debug', processTrail.add().toMessage({
    ...
    return consumerRef = consumerRef || engine.consume(function(msg, sandbox, done) {
      ...
      result.then(function(info) {
        ...
        LW.isEnabledFor('info') && LW.log('info', requestTrail.add().toMessage({
  ...
  this.close = function() {
    ...
    LW.isEnabledFor('info') && LW.log('info', closeTrail.add().toMessage({
  ...
  if (params.autoinit !== false) {
    LW.isEnabledFor('debug') && LW.log('debug', rpcWorkerTrail.add().toMessage({
...
function RpcResponse(params) {
  ...
  LR.isEnabledFor('info') && LR.log('info', requestTrail.add().toMessage({
    text: 'RpcResponse.new() end!'
  }));
}
