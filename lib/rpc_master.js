...
var RpcMaster = function(params) {
  ...
  params = lodash.defaults({mode: 'rpc_master'}, params, {engineId: misc.getLogID()});
  ...
  var timeoutConfig = { monitorType: 'rpcResponse', tasks: store.tasks };
  ...
  this.close = function() {
    ...
    return Promise.resolve().then(function() {
      ...
      if (monitorEnabled && timeoutMonitor) {
        var result = timeoutMonitor.stop();
        timeoutMonitor = null;
        return result;
      }
      return true;
