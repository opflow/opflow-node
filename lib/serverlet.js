...
var Instantiator = function(params) {
  ...
  LI.isEnabledFor('info') && LI.log('info', instantiatorTrail.add({
    message: 'Instantiator.new()'
  }).toString());
  ...
  var processor = function(body, headers, response) {
    ...
    return promise.then(function(output) {
      ...
      LI.isEnabledFor('info') && LI.log('info', routineTrail.add({
        message: 'processor() has completed successfully'
      }).toString());
      return Promise.resolve('done');
    }).catch(function(error) {
      response.emitFailed(error);
      LI.isEnabledFor('info') && LI.log('info', routineTrail.add({
        message: 'processor() has failed'
      }).toString());
      return Promise.resolve('done');
    }).finally(function() {
      LI.isEnabledFor('info') && LI.log('info', routineTrail.add({
