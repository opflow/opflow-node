...
var Serverlet = function(handlers, kwargs) {
  ...
  LX.isEnabledFor('info') && LX.log('info', serverletTrail.add().toMessage({
    text: 'Serverlet.new()'
  }));
  ...
  this.ready = function(opts) {
    ...
    opts = opts || {};
    opts.silent !== true &&
    LX.isEnabledFor('info') && LX.log('info', readyTrail.add().toMessage({
      text: 'ready() running'
    }));
    var actions = [];
  ...
  this.start = function() {
    ...
    LX.isEnabledFor('info') && LX.log('info', startTrail.add().toMessage({
      text: 'start() running'
    }));
  ...
  this.close = function() {
    ...
    LX.isEnabledFor('info') && LX.log('info', closeTrail.add().toMessage({
      text: 'close() running'
    }));
    var actions = [];
  ...
  if (kwargs.autoinit !== false) {
    LX.isEnabledFor('debug') && LX.log('debug', serverletTrail.add().toMessage({
...
var Instantiator = function(params) {
  ...
  LI.isEnabledFor('info') && LI.log('info', instantiatorTrail.add().toMessage({
  ...
  var processor = function(body, headers, response) {
    ...
    return promise.then(function(output) {
      ...
      LI.isEnabledFor('info') && LI.log('info', routineTrail.add().toMessage({
