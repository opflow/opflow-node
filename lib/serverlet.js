...
var Serverlet = function(handlers, kwargs) {
  ...
  var serverletCue = LogTracer.ROOT.branch({ key:'serverletId', value:serverletId });

  LX.isEnabledFor('info') && LX.log('info', serverletCue.add({
  ...
  LX.isEnabledFor('debug') && LX.log('debug', serverletCue.add({
  ...
  LX.isEnabledFor('conlog') && LX.log('conlog', serverletCue.add({
  ...
  this.ready = function(opts) {
    var readyCue = serverletCue.copy();
    opts = opts || {};
    opts.silent !== true && LX.isEnabledFor('info') && LX.log('info', readyCue.add({
    ...
    if (opts.silent !== true) return ok.then(function(results) {
      LX.isEnabledFor('info') && LX.log('info', readyCue.add({
  ...
  this.start = function() {
    var startCue = serverletCue.copy();
    LX.isEnabledFor('info') && LX.log('info', startCue.add({
  ...
  this.close = function() {
    var closeCue = serverletCue.copy();
    LX.isEnabledFor('info') && LX.log('info', closeCue.add({
