...
var Handler = function(params) {
  ...
  var logTracer = LogTracer.ROOT.branch({ key:'pubsubHandlerId', value:params.engineId });
  ...
  self.subscribe = function(callback) {
    ...
    if (listener == null) {
      ...
      LX.isEnabledFor('debug') && LX.log('debug', logTracer.add(error).toString());
    ...
    return engine.consume(function(msg, sandbox, done) {
      ...
      var logConsume = logRequest.branch({key:'subscriberId',value:sandbox.id});
