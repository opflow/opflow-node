...
var instanceId = null;
Object.defineProperty(misc, 'instanceId', {
  get: function() { return (instanceId = instanceId || uuidV4()) },
  set: function(value) {}
});
...
Object.defineProperty(misc, 'libraryInfo', {
  get: function() {
    return libraryInfo = libraryInfo || {
      instanceId: misc.instanceId,
      name: 'opflow-nodejs',
      version: loadPackageInfo().version,
      os: [os.platform(),os.release()].join('/')
    }
  },
  set: function(value) {}
});
...
var LX = LogAdapter.getLogger({ scope: 'opflow:util' });
